...
func (x *HelloReply) GetOk() string {
	if x != nil {
		return x.Ok
	}
	return ""
...
const file_health_v1_health_proto_rawDesc = "" +
	"\n" +
	"\x16health/v1/health.proto\x12\thealth.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x1c\n" +
	"\n" +
	"HelloReply\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\tR\x02ok2Z\n" +
	"\thealthSvc\x12M\n" +
	"\vCheckHealth\x12\x16.google.protobuf.Empty\x1a\x15.health.v1.HelloReply\"\x0f\x82\xd3\xe4\x93\x02\t\x12\a/healthB4Z2github.com/liuhuo23/liuhuo_layout/api/health/v1;v1b\x06proto3"
...
var file_health_v1_health_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_health_v1_health_proto_goTypes = []any{
	(*HelloReply)(nil),    // 0: health.v1.HelloReply
	(*emptypb.Empty)(nil), // 1: google.protobuf.Empty
}
var file_health_v1_health_proto_depIdxs = []int32{
	1, // 0: health.v1.healthSvc.CheckHealth:input_type -> google.protobuf.Empty
	0, // 1: health.v1.healthSvc.CheckHealth:output_type -> health.v1.HelloReply
