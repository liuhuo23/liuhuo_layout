...
type Server struct {
	...
	OpenapiPath   string                 `protobuf:"bytes,3,opt,name=openapi_path,json=openapiPath,proto3" json:"openapi_path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server) GetOpenapiPath() string {
	if x != nil {
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"\xdb\x02\n" +
	"\x06Server\x12+\n" +
	"\x04http\x18\x01 \x01(\v2\x17.kratos.api.Server.HTTPR\x04http\x12+\n" +
	"\x04grpc\x18\x02 \x01(\v2\x17.kratos.api.Server.GRPCR\x04grpc\x12!\n" +
	"\fopenapi_path\x18\x03 \x01(\tR\vopenapiPath\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\x06source\x18\x02 \x01(\tR\x06source\x1a\xe7\x01\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12<\n" +
	"\fread_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\vreadTimeout\x12>\n" +
	"\rwrite_timeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x12\x16\n" +
	"\x06prefix\x18\x06 \x01(\tR\x06prefixB7Z5github.com/go-kratos/kratos-layout/internal/conf;confb\x06proto3"
